...
'
 ...
 'Number of slides
    ...
    ActiveCell.Offset(1, 0).Value = "=SUBTOTAL(103,R2c3:r[-3]c)"
 'sum total nuclei
    ActiveCell.Offset(0, 1).Value = "Total Nuclei"
    ActiveCell.Offset(1, 1).Value = "=SUBTOTAL(109,R2C4:R[-3]C)"
 'sum AI IHC positive nuclei
    ActiveCell.Offset(0, 2).Value = "#IHC positive"
    ActiveCell.Offset(1, 2).Value = "=SUBTOTAL(109,R2C5:R[-3]C)"
 'sum confirmed positive nuclei
    ActiveCell.Offset(0, 3).Value = "#Confirmed"
    ActiveCell.Offset(1, 3).Value = "=SUBTOTAL(109,R2C6:R[-3]C)"
 'percent positive nuclei
    ActiveCell.Offset(0, 4).Value = "%IHC Positive"
    ActiveCell.Offset(1, 4).Value = "=RC[-1]/RC[-3]*100"
 ...
 'Reportable Results
    ...
    Selection.Value = "Test Nuclei>1M"
    ActiveCell.Offset(0, 1).FormulaR1C1 = "=IF(r[-5]c[2]>1000000,""YES"",""NO"")"
    ...
    ActiveCell.Offset(0, 1).FormulaR1C1 = "=IF(AND(r[-5]c[5]>r[0]c[3],r[-5]c[5]<r[0]c[4]),""YES"",""NO"")"
 ...
 'add border box
   ...
   'color OCT4 test
    Selection.FormatConditions.Add Type:=xlTextString, String:="OCPT", _
   ...
   'color 1%
    Selection.FormatConditions.Add Type:=xlTextString, String:="_1-", _
        TextOperator:=xlContains
    Selection.FormatConditions(Selection.FormatConditions.Count).SetFirstPriority
    ...
    'color 1%
    Selection.FormatConditions.Add Type:=xlTextString, String:="_1_", _
        TextOperator:=xlContains
    Selection.FormatConditions(Selection.FormatConditions.Count).SetFirstPriority
